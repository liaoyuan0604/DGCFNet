...
class LoveDATrainDataset(Dataset):
    def __init__(self, data_root='/data/AIfusion/Tony2016Edu/Datasets/Seg_data/data/LoveDA/Train', img_dir='images_png', mosaic_ratio=0.25,
...
loveda_val_dataset = LoveDATrainDataset(data_root='/data/AIfusion/Tony2016Edu/Datasets/Seg_data/data/loveda/Val', mosaic_ratio=0.0,
                                        transform=val_aug)


class LoveDATestDataset(Dataset):
    def __init__(self, data_root='/data/AIfusion/Tony2016Edu/Datasets/Seg_data/data/loveda/Test', img_dir='images_png',
