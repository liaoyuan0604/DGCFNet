...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="/data/AIfusion/Tony2016Edu/Yuan_Liao/GeoSeg-main/bludata/train/image")
    parser.add_argument("--mask-dir", default="/data/AIfusion/Tony2016Edu/Yuan_Liao/GeoSeg-main/bludata/train/label")
    parser.add_argument("--output-img-dir", default="/data/AIfusion/Tony2016Edu/Yuan_Liao/GeoSeg-main/bludata/train/image_1024")
    parser.add_argument("--output-mask-dir", default="/data/AIfusion/Tony2016Edu/Yuan_Liao/GeoSeg-main/bludata/train/label_1024")
