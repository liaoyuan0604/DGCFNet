...
def parse_args():
    ...
    parser.add_argument("--input-dir", default="data/blu/uavid_train_val")
    parser.add_argument("--output-img-dir", default="data/blu/train_val/images")
    parser.add_argument("--output-mask-dir", default="data/blu/train_val/masks")
