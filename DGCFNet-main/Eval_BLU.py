...
from models.FCN_8s import FCN_res18
...
args = {
    ...
    'load_path': '/data/AIfusion/Tony2016Edu/Yuan_Liao/WiCoNet-main/checkpoints/BLU/UNetFormer_118e_OA84.55.pth'
}
...
def main():
    net = UNetFormer(num_classes=BLU.num_classes+1).cuda()
    ...
    val_set = BLU.Loader(args['data_dir'], 'test', sliding_crop=False, size_context=args['size_context'], size_local=args['size_local'])
