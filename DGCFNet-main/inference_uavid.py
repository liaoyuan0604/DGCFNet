...
def get_args():
    ...
    arg("-i", "--image_path", type=str, default='data/blu/uavid_test', help="Path to  huge image")
    ...
    arg("-d", "--dataset", help="dataset", default="blu", choices=["pv", "landcoverai", "blu"])
